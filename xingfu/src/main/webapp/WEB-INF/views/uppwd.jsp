...
<div class="quanbu">
    ...
    店长管理                                                 
        ...
        <a href="#">房源</a><br>
         ...
         <div id="right" class="right" >
    <form action="uppwd2" method="post">
        修改密码:<input name="password" type="password" placeholder="请输入密码" required="required"/><br>
   重复密码:<input type="password" placeholder="请输入重复密码" required="required"/><br>
