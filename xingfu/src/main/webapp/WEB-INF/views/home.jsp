...
<body style= "overflow-x: hidden">
     ...
     <div class="zhanghao">
             <label>账号:</label>
               <input class="a"  type="text" name="name" id="User_Name" placeholder="请输入账号" required="required"/>
      </div>
      <div class="mima">
            <label>密码:</label>
               <input class="b" type="password" name="password" id="User_Pwd" placeholder="请输入密码" required="required"/>
      </div>
             <div class="danxuan">
                 <input type="checkbox"/>
                 <label>是否记住密码?</label>
         ...
         <div class="tijiao">
             <input class="t" type="submit" value="登陆" onclick="return checkName()">
         </div>
