...
<div class="quanbu">
    ...
    <form action="addclient2" method="post">
       姓&nbsp;&nbsp;名:<input type="text" name="name"/><br>
       联系电话:<input type="password" name="phone"/><br>
      房源地区:<input type="text" name="urban"/><br>
      户型:<select name="uit">
  ...
  设施:<input type="text" name="faclity"/><br>
       状态:<input type="text" name="state" />(0未租 1已租)<br>
